...
export function ComponentPreviewContainer({
  ...
  return (
    <div
      className={cn("component-preview-container group relative space-y-4 my-4 w-full", className)}
      data-name={name}
    ...
    >
      ...
      <div
        data-name={name}
        className={cn(
          "preview not-prose relative min-h-87.5 w-full overflow-hidden rounded-xl border border-separator p-4 sm:p-10",
