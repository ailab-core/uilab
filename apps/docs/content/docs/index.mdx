...
uilab is a react component library. Built on top of [Radix UI Primitives](https://www.radix-ui.com/primitives), styled with [Tailwind CSS](https://tailwindcss.com/) and bundled with [rolldown](https://rolldownjs.org/).
