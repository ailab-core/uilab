...
```tsx
import { Card, CardHeader, CardTitle, CardDescription, CardContent, CardFooter, Button } from 'uilab-core'
...
<ComponentPreview title="Simple Card" description="A card without header or footer">
  <Card className="w-[350px] p-6">
    <p className="text-sm">
      This is a simple card with just content. Perfect for quick information displays.
    </p>
  </Card>
</ComponentPreview>
...
<ComponentPreview title="Card Grid" description="Cards work great in grid layouts">
